...
namespace ProjCharGenerator.Test
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod4()
        {
            ...
            string[] s = File.ReadAllLines("mod-lab05-gen/work_results/tests/BigramGeneratorTest.txt");
        ...
        public void TestMethod6()
        {
            ...
            WordGenerator generator = new WordGenerator("mod-lab05-gen/sources/Words.txt");
        ...
        public void TestMethod7()
        {
            ...
            string[] s = File.ReadAllLines("mod-lab05-gen/work_results/tests/WordGeneratorTest.txt");
        ...
        {
            WordBigramGenerator generator = new WordBigramGenerator("mod-lab05-gen/sources/WB.txt");
        ...
        public void TestMethod13()
        {
            ...
            string[] s = File.ReadAllLines("mod-lab05-gen/work_results/tests/WordBigramGenerator.txt");
            string[] receivedValue = s[0].Split(" ");
            Assert.IsTrue(receivedValue.Length >= 1000);
        }
    }
